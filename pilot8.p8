 ...
 for r=0,31,6 do
  for c=0,128 do
   ...
   elseif t==48+15 and last_lvl then
    last_lvl=nil
   elseif t==114 and last_lvl then
    last_lvl.num_waves+=1
   end
  end
  last_lvl=nil
...
function update_plr()
 ...
 if g.hurt_cd>flr(40/2) then
  ...
  dx,dy=get_dpad()
  local spd=has_upgrade(0x0001) and 2 or 1
  dx*=spd
  dy*=spd
 end
 ...
 g.lit_clip.x+=interp(1,0,-1,-40,g.facing_frac)
end
function fire()
...
function get_rapid_fire_upg_lvl()
 return has_upgrade(0x0008) and 3 or
   has_upgrade(0x0004) and 2 or
   has_upgrade(0x0002) and 1 or 0
end
function get_ammo_upg_lvl()
 return has_upgrade(0x0040) and 3 or
   has_upgrade(0x0020) and 2 or
...
function lvl_exec_next_cmd()
 ...
 if g.next_cmd==0 then marker=114 end
 if marker==114 then
...
__gfx__

...

...

...

...
__map__

...

...

...

